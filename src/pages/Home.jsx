...
// console.log("reviewSlider is ->",ReviewSlider);
...
const Home = () => {
  return (
    <div>
      ...
      {/*Section 3 */}
      <div className='relative my-20 w-11/12 mx-auto max-w-maxContent flex-col items-center justify-between gap-8 first-letter bg-richblack-900 text-white'>
